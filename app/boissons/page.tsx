...
export const metadata: Metadata = { title: "Boissons, Cafés & Smoothies", description: "Découvrez les cafés, chocolats chauds, milkshakes, smoothies et boissons fraîches de Chill'in à Dunkerque.", alternates: { canonical: "/boissons" } };
